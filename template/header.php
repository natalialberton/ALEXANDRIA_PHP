                        ...
                        <form method="POST">
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="user_cpf" required pattern="\d{3}\.\d{3}\.\d{3}-\d{2}"
                                        title="000.000.000-00" maxlength="14" onkeypress="mascara(this,cpfMasc)"
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="user_telefone" required
                                        pattern="\(?\d{2}\)?[\s-]?\d{4,5}[\s-]?\d{4}" title="(00) 00000-0000" maxlength="15"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="user_email"
                                        value="<?= htmlspecialchars($usuarioLogado['user_email']) ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="user_dataAdmissao"
                                        value="<?= htmlspecialchars($usuarioLogado['user_dataAdmissao']) ?? null ?>" required>
                                </div>
