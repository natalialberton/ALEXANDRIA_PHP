function animaIconeMenu(x) {
    ...
    {
        document.getElementById("navegaMenu").style.width = "15rem";
        document.getElementById("iconeMenu").style.marginLeft = "8rem";
    ...
    else if (barra2.style.opacity != 0)
    {
        ...
        document.getElementById("iconeMenu").style.marginLeft = "1rem";
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    } else if (window.location.hash === '#editarRemessa') {
